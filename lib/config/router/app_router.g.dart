...
RouteBase get $homeRoute => GoRouteData.$route(
  ...
  routes: [
    GoRouteData.$route(path: 'details/:id', factory: $DetailsRoute._fromState),
  ],
);
...
mixin $DetailsRoute on GoRouteData {
  static DetailsRoute _fromState(GoRouterState state) =>
      DetailsRoute(id: state.pathParameters['id']!);
...
String _$appRouterHash() => r'3054a4882b822a57e71ea70c204a03b3774214fe';
